...
export function useEditorState() {
    ...
    try {
      ...
      if (gameId === "xenoblade") {
        ...
        const csvFiles = [
          ...
          { url: `${baseUrl}/Item/STR_ItemName_01_Art.csv`, category: "Art" },
          { url: `${baseUrl}/Item/STR_ItemName_19_Umbrella.csv`, category: "Clothing" },
          ...
          { url: `${baseUrl}/Item/STR_ItemName_36_InsectToy.csv`, category: "Insects" },
          { url: `${baseUrl}/Item/STR_ItemName_37_FishToy.csv`, category: "Fish" },
          { url: `${baseUrl}/Item/STR_ItemName_40_Plant.csv`, category: "Plants" },
          { url: `${baseUrl}/Item/STR_ItemName_41_Turnip.csv`, category: "Plants" },
          { url: `${baseUrl}/Item/STR_ItemName_50_RoomWall.csv`, category: "Wallpaper" },
          { url: `${baseUrl}/Item/STR_ItemName_51_RoomFloor.csv`, category: "Wallpaper" },
          { url: `${baseUrl}/Item/STR_ItemName_52_RoomRug.csv`, category: "Wallpaper" },
          { url: `${baseUrl}/Item/STR_ItemName_61_HouseDoorDeco.csv`, category: "Furniture" },
          { url: `${baseUrl}/Item/STR_ItemName_62_HousePost.csv`, category: "Furniture" },
          ...
          { url: `${baseUrl}/Item/STR_ItemName_81_Event.csv`, category: "Events" },
          { url: `${baseUrl}/Item/STR_ItemName_82_Music.csv`, category: "Music" },
          { url: `${baseUrl}/Item/STR_ItemName_83_Fence.csv`, category: "Fences" },
          { url: `${baseUrl}/Item/STR_ItemName_84_Bromide.csv`, category: "Art" },
          { url: `${baseUrl}/Item/STR_ItemName_85_BridgeSlope.csv`, category: "Furniture" },
          { url: `${baseUrl}/Item/STR_ItemName_86_Poster.csv`, category: "Art" },
          // Outfits (Clothing)
          { url: `${baseUrl}/Outfit/GroupName/STR_OutfitGroupName_Accessory.csv`, category: "Clothing" },
          { url: `${baseUrl}/Outfit/GroupName/STR_OutfitGroupName_Bag.csv`, category: "Clothing" },
          { url: `${baseUrl}/Outfit/GroupName/STR_OutfitGroupName_Bottoms.csv`, category: "Clothing" },
          { url: `${baseUrl}/Outfit/GroupName/STR_OutfitGroupName_Cap.csv`, category: "Clothing" },
          { url: `${baseUrl}/Outfit/GroupName/STR_OutfitGroupName_Helmet.csv`, category: "Clothing" },
          { url: `${baseUrl}/Outfit/GroupName/STR_OutfitGroupName_MarineSuit.csv`, category: "Clothing" },
          { url: `${baseUrl}/Outfit/GroupName/STR_OutfitGroupName_OnePiece.csv`, category: "Clothing" },
          { url: `${baseUrl}/Outfit/GroupName/STR_OutfitGroupName_Shoes.csv`, category: "Clothing" },
          { url: `${baseUrl}/Outfit/GroupName/STR_OutfitGroupName_Socks.csv`, category: "Clothing" },
          { url: `${baseUrl}/Outfit/GroupName/STR_OutfitGroupName_Tops.csv`, category: "Clothing" },
          // NPCs
          { url: `${baseUrl}/Npc/STR_NNpcName.csv`, category: "Villagers" },
          { url: `${baseUrl}/Npc/STR_NNpcPhrase.csv`, category: "Villagers" },
          { url: `${baseUrl}/Npc/STR_SNpcName.csv`, category: "Special NPCs" },
          { url: `${baseUrl}/Npc/STR_SNpcOtherName.csv`, category: "Special NPCs" },
          // Special
          { url: `${baseUrl}/Sp/STR_Dinosaur.csv`, category: "Fossils" },
          { url: `${baseUrl}/Sp/STR_Emoticon.csv`, category: "Miscellaneous" },
          // Remake / Customization
          { url: `${baseUrl}/Remake/STR_Remake_BodyColor.csv`, category: "Crafting" },
          { url: `${baseUrl}/Remake/STR_Remake_BodyParts.csv`, category: "Crafting" },
          { url: `${baseUrl}/Remake/STR_Remake_FabricColor.csv`, category: "Crafting" },
          { url: `${baseUrl}/Remake/STR_Remake_FabricParts.csv`, category: "Crafting" },
          // Root files
          { url: `${baseUrl}/STR_CategoryName.csv`, category: "Miscellaneous" },
          { url: `${baseUrl}/STR_Constellation.csv`, category: "Miscellaneous" },
          { url: `${baseUrl}/STR_EventName.csv`, category: "Events" },
          { url: `${baseUrl}/STR_HouseDoorName.csv`, category: "Furniture" },
          { url: `${baseUrl}/STR_HouseRoofName.csv`, category: "Furniture" },
          { url: `${baseUrl}/STR_HouseWallName.csv`, category: "Furniture" },
  ...
  return {
    ...
    fixingMixed, filtersOpen, buildStats, buildPreview, showBuildConfirm, bdatFileStats, showCobaltBuildChoice, setShowCobaltBuildChoice, handleBuildCobaltAs, autoTrimMsbt, toggleAutoTrimMsbt,
